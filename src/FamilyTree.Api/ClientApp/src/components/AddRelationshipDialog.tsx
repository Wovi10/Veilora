...
export default function AddRelationshipDialog({ open, person1, person2, onClose, onCreated }: Props) {
    ...
    <Dialog open={open} onClose={handleClose} fullWidth maxWidth="sm">
      ...
      <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: '16px !important' }}>
        ...
        <Typography variant="body2" color="text.secondary">
          <strong>Person 1:</strong> {fullName(person1)}
        </Typography>
        <Typography variant="body2" color="text.secondary">
          <strong>Person 2:</strong> {fullName(person2)}
        </Typography>
